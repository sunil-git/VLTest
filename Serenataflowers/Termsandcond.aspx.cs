...
{
    public partial class Termsandcond : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ltTitle.Text = "\n<title>" + CommonFunctions.PageTitle() +" - Terms and Conditions "+ "</title>\n";
            CreateMetaTags();
        }
