<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="m_checkoutReview.aspx.cs"
    Inherits="Serenataflowers.m_checkoutReview" %>
...
<head id="Head1" runat="server">
    ...
    <title>Serenata Flowers - Review</title>
            ...
            <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    ...
                    <div align="center" style="margin: 5px 0 5px 0;">
                        ...
                        <asp:Button ID="Confirmpayment" runat="server" data-theme="d" Text="Confirm payment" OnClick="Confirmpayment_Click"
                            /><br />
