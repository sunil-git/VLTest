...
namespace Serenata_Checkout.PaymentGateway
{
    ...
    public class NVPAPICaller
    {
        ...
        public string APIUsername = ConfigurationManager.AppSettings["PaypalUsername"];
        private string APIPassword = ConfigurationManager.AppSettings["PaypalPassword"];
        private string APISignature = ConfigurationManager.AppSettings["PaypalSignature"];
        ...
        /// <returns></returns>
        public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg, List<KeyValuePair<string, string>> customParams,string encryptedOrderId,string domain)
        {
            ...
            string returnURL ="https://"+domain+ConfigurationManager.AppSettings["PaypalReturnURL"] + encryptedOrderId;
            string cancelURL = "https://"+domain+ConfigurationManager.AppSettings["PaypalCalcelURL"] + encryptedOrderId;
        ...
        public bool MarkExpressCheckout(string amt,
                            ...
                            string shipToCountryCode, ref string token, ref string retMsg, string encryptedOrderId)
        {
            string host = "www.paypal.com";
            if (environment == "live")
            {
            ...
            //string returnURL = "http://localhost:4899/Paileyweaves/PaymentSuccess.aspx";
            //string cancelURL = "http://localhost:4899/Paileyweaves/PaymentCancel.aspx";
            string returnURL = ConfigurationManager.AppSettings["PaypalReturnURL"] + encryptedOrderId;
            string cancelURL = ConfigurationManager.AppSettings["PaypalCalcelURL"] + encryptedOrderId;
        ...
        public bool GetShippingDetails(string token, ref string PayerId, ref string ShippingAddress, ref string retMsg)
        {
            ...
            if (strAck != null && (strAck == "success" || strAck == "successwithwarning"))
            {
                ...
                ShippingAddress += "<td><b> Shipping Address </b></td><td></td></tr>";
                ...
                ShippingAddress += "<td> Zip     :</td><td>" + decoder["SHIPTOZIP"] + "</td></tr>";
                ShippingAddress += "<td> Email   :</td><td>" + decoder["EMAIL"] + "</td>";
                // ShippingAddress += "<td> Payer Status </td><td>" + decoder["PAYERSTATUS"] + "</td></tr>";
                // ShippingAddress += "<td> Payer Id </td><td>" + decoder["PAYERID"] + "</td>";
        ...
        public bool ConfirmPayment(string finalPaymentAmount, string token, string PayerId, ref NVPCodec decoder, ref string retMsg)
        {
            ...
            if (strAck != null && (strAck == "success" || strAck == "successwithwarning"))
            {
                string payamt = decoder["PAYMENTINFO_0_AMT"];
