...
namespace Serenata_Checkout.Dal
{
    ...
    public sealed class DBManager : DBManagerBase
    {
        ...
        {
            connectionString = System.Configuration.ConfigurationSettings.AppSettings["SerenaConnectionString"];
           // connectionString = System.ConfigurationManager.ConnectionStrings["SerenaConnectionString"].ConnectionString;  
